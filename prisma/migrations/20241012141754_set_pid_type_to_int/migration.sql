/*
  ...
  - You are about to alter the column `pid` on the `image` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
  ...
  - You are about to alter the column `pid` on the `manga` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
